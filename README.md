...
The app relies on a secret set as the environment variable `JWT_SECRET` to produce a JWT. The `.env_file` file contains the list of environment variables required by the project in the format:
```bash
